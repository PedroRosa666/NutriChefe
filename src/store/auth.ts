...
index 9dbc0735cfc091fe89192d9a78d6e69ddc044beb..4b26be1ebf03b0ac9aec89c382c1ca89089edc1b 100644
--- a/src/store/auth.ts
+++ b/src/store/auth.ts
@@ -5,50 +5,51 @@ import { getUserProfile } from '../services/database';
...
@@ -141,45 +142,74 @@ export const useAuthStore = create<AuthState>()(
             }
           });
