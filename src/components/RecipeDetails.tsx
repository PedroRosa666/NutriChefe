      ...
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm overflow-y-auto z-50">
        <div className="min-h-screen flex items-center justify-center p-4">
          <div className="relative max-w-5xl w-full">
            <div className="absolute -top-10 right-0 hidden md:block text-xs uppercase tracking-[0.2em] text-gray-300 dark:text-gray-500">
            ...
            <div className="bg-white/95 dark:bg-gray-900/95 rounded-2xl shadow-2xl border border-gray-200/80 dark:border-gray-700/70 overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 pt-4 pb-2 border-b border-gray-100 dark:border-gray-800">
                <span className="text-xs font-medium uppercase tracking-[0.25em] text-gray-400 dark:text-gray-500">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4 md:space-y-6">
                    <div className="relative group">
                      ...
                      <div className="absolute bottom-3 left-3 inline-flex items-center gap-2 rounded-full bg-black/60 px-3 py-1 text-xs text-white backdrop-blur">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/60 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="inline-flex items-center rounded-full bg-emerald-50 dark:bg-emerald-900/30 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-700 dark:text-emerald-200">
                  ...
                  <div className="space-y-4 md:space-y-5">
                    ...
                    <div className="flex justify-between items-start gap-3">
                      <div>
                        ...
                        <div className="mt-2 flex flex-wrap gap-2 items-center">
                          <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border border-emerald-500/30 px-3 py-1 text-xs font-medium">
                      ...
                      <div className="flex gap-1.5">
                        {isAuthenticated && (
                          <button
                            ...
                            className={cn(
                              'p-2.5 rounded-full border text-sm shadow-sm transition-all',
                              isFavorite
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-xs text-gray-500 dark:text-gray-300 border-y border-gray-100 dark:border-gray-800 py-3">
                    ...
                    <div className="bg-emerald-50/70 dark:bg-emerald-900/20 p-4 rounded-xl border border-emerald-100 dark:border-emerald-800/60">
                      <h3 className="text-sm font-semibold mb-2 text-gray-900 dark:text-white flex items-center gap-2">
                        <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500/15">
                          <Star className="w-3 h-3 text-emerald-600 dark:text-emerald-300" />
                        </span>
                  ...
                  {canAddReview && (
                    ...
                    >
                      ...
                      <textarea
                        ...
                        className="w-full p-2.5 border border-gray-300 dark:border-gray-700 rounded-lg mb-2 text-sm text-gray-900 dark:text-white bg-white dark:bg-gray-900"
                        rows={3}
                        required
                      />
                      <button
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          type="button"
                          onClick={() => setEditingReview(null)}
                          className="px-4 py-2 bg-gray-200 text-gray-700 text-sm rounded-lg hover:bg-gray-300 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 transition-colors"
                        >
                          Cancelar
                        </button>
                      </div>
