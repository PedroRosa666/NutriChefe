    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
        <div className="relative w-full max-w-md rounded-2xl bg-white/95 shadow-2xl dark:bg-slate-900/95 border border-slate-100/70 dark:border-slate-800">
          ...
          <button
            onClick={onClose}
            className="absolute right-3 top-3 inline-flex h-8 w-8 items-center justify-center rounded-full text-slate-400 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-slate-800"
          >
            <X className="h-5 w-5" />
          ...
          <div className="flex items-center gap-3 px-5 pt-5 pb-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-900/40 dark:text-emerald-300">
          ...
          {/* Abas Sign In / Sign Up mais enxutas */}
          ...
          <form
            ...
            className="space-y-3 border-t border-slate-100 px-5 pb-5 pt-4 dark:border-slate-800 text-sm"
          >
            {isSignup && (
              <>
                <div className="space-y-1">
                  <label
                    htmlFor="name"
                    className="block text-xs font-medium text-slate-700 dark:text-slate-100"
                  >
                    {t.profile.name}
                  </label>
                  <input
                ...
                <div className="space-y-1">
                  <label className="block text-xs font-medium text-slate-700 dark:text-slate-100">
                    {t.profile.accountType}
                  </label>
                  <div className="inline-flex rounded-full border border-slate-200 bg-slate-50 p-1 text-xs dark:border-slate-700 dark:bg-slate-900">
                    <button
                      type="button"
