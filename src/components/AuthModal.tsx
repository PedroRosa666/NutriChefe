  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
        <div className="relative w-full max-w-md my-8 overflow-hidden rounded-2xl bg-white/95 shadow-2xl dark:bg-slate-900/95 border border-slate-100/70 dark:border-slate-800 max-h-[90vh] flex flex-col">
          {/* Botão fechar */}
          <button
            onClick={onClose}
          ...
          {/* Wrapper scrollável do conteúdo */}
          <div className="flex flex-1 flex-col min-h-0">
            {/* Header */}
            <div className="flex flex-col items-center gap-3 px-6 pt-8 pb-4 text-center shrink-0">
            ...
            {/* Formulário (área que pode scrollar) */}
            <form
              onSubmit={handleSubmit}
              className="space-y-4 border-t border-slate-100 px-6 pb-6 pt-4 dark:border-slate-800 overflow-y-auto"
            >
              {isSignup && (
                <>
                  <div className="space-y-1">
