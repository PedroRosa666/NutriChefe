  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <div className="rounded-2xl border border-emerald-900/40 bg-slate-900/60 p-4 shadow-sm dark:bg-slate-900/70">
          <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-slate-300">
            <BookOpen className="h-4 w-4 text-emerald-400" />
            <span>{t.profile.publishedRecipes}</span>
          </div>
          <p className="text-3xl font-bold text-emerald-400">{userRecipes.length}</p>
        </div>
        ...
        <div className="rounded-2xl border border-emerald-900/40 bg-slate-900/60 p-4 shadow-sm dark:bg-slate-900/70">
          ...
          <p className="text-3xl font-bold text-emerald-400">{totalReviews}</p>
        </div>
